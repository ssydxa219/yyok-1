...
DROP DATABASE IF EXISTS yyok_admin;
CREATE DATABASE yyok_admin DEFAULT CHARSET utf8mb4;
USE yyok_admin;

-- 用户组表
DROP TABLE IF EXISTS yyok_groups;
CREATE TABLE yyok_groups
(
...
-- 岗位表
DROP TABLE IF EXISTS yyok_position;
CREATE TABLE yyok_position
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
...
-- 菜单表
DROP TABLE IF EXISTS yyok_menu;
CREATE TABLE yyok_menu
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
...
-- 用户和组关系表
DROP TABLE IF EXISTS yyok_user_group_relation;
CREATE TABLE yyok_user_group_relation
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
...
-- 用户和岗位系表
DROP TABLE IF EXISTS yyok_user_position_relation;
CREATE TABLE yyok_user_position_relation
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
    user_id      VARCHAR(20)  NOT NULL COMMENT '用户id',
...
-- 角色和菜单关系表
DROP TABLE IF EXISTS yyok_role_menu_relation;
CREATE TABLE yyok_role_menu_relation
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
...
--  用户表
DROP TABLE IF EXISTS yyok_users;
CREATE TABLE yyok_users
(
...
CREATE UNIQUE INDEX ux_users_username
    ON yyok_users (username);
CREATE UNIQUE INDEX ux_users_mobile
    ON yyok_users (mobile);

--  角色表
DROP TABLE IF EXISTS yyok_roles;
CREATE TABLE yyok_roles
(
...
-- 资源表
DROP TABLE IF EXISTS yyok_resource;
CREATE TABLE yyok_resource
(
...
CREATE UNIQUE INDEX ux_resource_code
    ON yyok_resource (code);

-- 用户和角色关系表
DROP TABLE IF EXISTS yyok_user_role_relation;
CREATE TABLE yyok_user_role_relation
(
...
-- 角色和资源关系表
DROP TABLE IF EXISTS yyok_role_resource_relation;
CREATE TABLE yyok_role_resource_relation
(
    id           VARCHAR(20) PRIMARY KEY COMMENT '关系id',
...
-- 用户
INSERT INTO yyok_users (id, username, password, deleted, enabled, account_non_expired, credentials_non_expired, account_non_locked, name, mobile, created_time, updated_time, created_by, updated_by)
VALUES
...
-- 角色
INSERT INTO yyok_roles (id, code, name, description, created_time, updated_time, created_by, updated_by)
...
-- 资源
INSERT INTO yyok_resource (id, name, code, type, url, method, description, created_time, updated_time, created_by, updated_by)
...
-- 用户关系授权
INSERT INTO yyok_user_role_relation (id, user_id, role_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system'),
       (103, 102, 103, now(), now(), 'system', 'system');
-- 角色与资源关系表
INSERT INTO yyok_role_resource_relation (id, role_id, resource_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
...
-- 岗位
INSERT INTO yyok_position (id, name, description, created_time, updated_time, created_by, updated_by)
...
-- 用户组
INSERT INTO yyok_groups (id, parent_id, name, description, created_time, updated_time, created_by, updated_by)
...
-- 菜单
INSERT INTO yyok_menu (id, parent_id, type, href, icon, name, description, order_num, created_time, updated_time, created_by, updated_by)
...
INSERT INTO yyok_user_group_relation (id, user_id, group_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system');
INSERT INTO yyok_user_position_relation (id, user_id, position_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 103, now(), now(), 'system', 'system'),
       (102, 102, 103, now(), now(), 'system', 'system');
-- 角色关系表
INSERT INTO yyok_role_menu_relation (id, role_id, menu_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 101, 102, now(), now(), 'system', 'system'),
       (103, 101, 103, now(), now(), 'system', 'system'),
