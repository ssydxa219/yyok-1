(function (b) {
    ...
    a.props = function (h, f) {
        var j = this,
            c = b("#flow_props").hide().draggable({handle: "#flow_props_handle"}).resizable().css(a.config.props.attr).bind("click", function () {
                return false
    ...
    a.init = function (x, r) {
        ...
        b(y).data("mod", "point");
        if (a.config.editable) {
            b("#flow_tools").draggable({handle: "#flow_tools_handle"}).css(a.config.tools.attr);
            b("#flow_tools .node").hover(function () {
                b(this).addClass("mover")
            }, function () {
                b(this).removeClass("mover")
            });
            b("#flow_tools .selectable").click(function () {
                b(".selected").removeClass("selected");
                b(this).addClass("selected");
                b(y).data("mod", this.id)
            });
            b("#flow_tools .state").each(function () {
