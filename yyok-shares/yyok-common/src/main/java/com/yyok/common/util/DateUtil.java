...
public class DateUtil {
    ...
    //format
    static final String defaultFormat = "yyyy-MM-dd HH:mm:ss";
    static String ymdhms = defaultFormat;
    static String emdhmsz = "EEE MMM dd HH:mm:ss Z yyyy";

    public static String parseStr(String strdate,String strformat) {
        String sDate = "";
        SimpleDateFormat sdf1 = new SimpleDateFormat(strformat, Locale.UK);
        try {
    ...
    public static String format(Calendar date) {
        ...
        return format(date.getTime(), ymdhms);
    }
    ...
    public static SimpleDateFormat getSimpleDateFormatPattern(String dateStr) {
        ...
        if (Pattern.matches("\\d{4}-\\d{1,2}-\\d{1,2}", dateStr)) {
            ...
            format = new SimpleDateFormat(ymdhms);
        } else {
            format = new SimpleDateFormat(ymdhms);
        }
        return format;
    ...
    public static Date parseDateByPattern(String dateStr) {
        ...
        try {
            if (Pattern.matches("\\d{4}-\\d{2}-\\d{2}", dateStr)) {
                ...
                format = new SimpleDateFormat(ymdhms, Locale.CHINA);
                return format.parse(dateStr);
...
// e.printStackTrace();
    ...
    public static String transFormationStringDate(String date) {
        Date now = new Date();
        SimpleDateFormat sss = new SimpleDateFormat(ymdhms);
     ...
     * @returnType Date
     * @createTime 2020年2月28日下午6:21:28
     */
