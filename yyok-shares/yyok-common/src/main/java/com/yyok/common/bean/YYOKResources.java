...
public class YYOKResources implements Serializable {
    @Id
    @Column(name = "ID")
    private String id;
     ...
     */
    @Transient
    private List<YYOKResources> subModules;
    ...
    public List<YYOKResources> getSubModules() {
        return subModules;
    }

    public void setSubModules(List<YYOKResources> subModules) {
