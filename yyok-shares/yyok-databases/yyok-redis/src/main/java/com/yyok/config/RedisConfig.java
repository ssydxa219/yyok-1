package com.yyok.config;


import com.yyok.repository.FastJson2JsonRedisSerializer;
import com.yyok.repository.RedisTemplate;
...
public class RedisConfig {
     ...
     */
    @Bean(name = "redisUtil")
    public RedisServiceImpl redisUtil(RedisTemplate redisTemplate) {
