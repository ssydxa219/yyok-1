...
public class ShellExecutorUtil {
    ...
    public ShellExecutorUtil(String ip, String usr, String pasword) {
        this.ip = ip;
        this.osUsername = usr;
    ...
    public static void main(String args[]) throws Exception {
        ShellExecutorUtil executor = new ShellExecutorUtil("192.168.243.21", "root", "dd@20204#");
        // 执行myTest.sh 参数为java Know dummy
        System.out.println(executor.exec("python /data/bluemoon/kettle/runScript/ods/fact_org_employee.py "));
    }
}