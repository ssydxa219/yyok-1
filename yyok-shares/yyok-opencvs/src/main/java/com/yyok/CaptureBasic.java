...
public class CaptureBasic extends JPanel {
    ...
    public static Mat detectFace(Mat img) throws Exception {
        ...
        String ms1 = "haarcascade_frontalface_alt.xml";
        String ms2 = "haarcascade_frontalcatface_extended.xml";
        String ms3 = "haarcascade_eye.xml";
        String ms = ms1;
        // 从配置文件lbpcascade_frontalface.xml中创建一个人脸识别器，该文件位于opencv安装目录中
        CascadeClassifier faceDetector = new CascadeClassifier("D:\\ProgramFiles\\opencv\\sources\\data\\haarcascades\\"+ms);
