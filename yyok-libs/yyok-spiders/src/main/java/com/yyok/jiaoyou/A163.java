...
public class A163 {
    public static String LOGIN_URL = "http://yuehui.163.com/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        simulateLogin("ssydxa219@126.com", "sa820219sa!@#"); // 模拟登陆github的用户名和密码
    ...
    public static void simulateLogin(String userName, String pwd) throws Exception {
         ...
         */
        Connection con2 = Jsoup.connect("http://yuehui.163.com/searchusers.do");
